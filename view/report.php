...
?>
    ...
    <div class="container-fluid page-header py-6 my-6 mt-0 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">User Report</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="#">Pages</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">user report</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <h6 class="text-primary text-uppercase mb-2">User Report</h6>
                    <h1 class="display-6 mb-4">Make A User Report To complain user if he done any thing wrong</h1>
                    <form>
                        <div class="row g-3">
                            <div class="col-sm-6">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    ...
                                    <label for="message">What's your problem?</label>
                                </div>
                            </div>
                            <div class="col-12">
